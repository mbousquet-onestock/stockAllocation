...
export function buildRules(): SegmentationRule[] {
  ...
  return [
    ...
    },
    {
      ...base,
      id: 'rule-3',
      name: 'Calor irons – all stock types',
      priority: 3,
      criteria: [
      ...
      stockTypeIds: [],
      shares: { ...shares(40, 40, 'on_hand'), ...shares(50, 50, 'container'), ...shares(50, 50, 'planned') },
    },
    {
      ...base,
      id: 'rule-4',
